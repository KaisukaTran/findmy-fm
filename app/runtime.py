...
KSS_SETTING_FIELDS: dict[str, Callable[..., object]] = {
    ...
    "ladder_coverage_pct": float,  # % of each full ladder the budget pre-books (100 = all of it)
    "deep_ladder_lock_rungs": int,  # a ladder this deep locks its whole reserve (0 = off)
    ...
    # Loss re-entry escalation (weeks-based): block re-opening a stopped-out coin, escalating.
    "loss_reentry_enabled": _to_bool,
    "loss_reentry_weeks_1": int,
